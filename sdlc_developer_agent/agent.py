"""sdlc-developer-agent: operational agent implementing agent_role == "developer".
...
ACTIONS: Dict[str, Callable[[dict], ActionResult]] = {
    ...
    "repository.write": _stub("repository.write", "write application code on a non-protected branch"),
    "architecture.propose": _stub("architecture.propose", "propose an architecture/contract change for review")
}
