"""Command-line entrypoint: `python -m sdlc_developer_agent <command> ...`."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog=f"python -m sdlc_developer_agent", description=f"{ROLE} agent CLI")
